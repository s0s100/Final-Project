...
SpotLight::SpotLight() : innerCone(1.0f), outerCone(1.0f) {}

SpotLight::SpotLight(glm::vec3 position, glm::vec4 color, glm::vec3 direction, float innecCone, float outerCone): 
	DirectionalLight(position, color, direction) {
