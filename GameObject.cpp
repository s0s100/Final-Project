...
GameObject::GameObject() : mesh(Mesh()), position(glm::vec3(0.0f, 0.0f, 0.0f)),
...
void GameObject::setAcceleration(glm::vec3 newAcceleration) {
	this->acceleration = newAcceleration;
}

void GameObject::addVelocity(glm::vec3 addedValue) {
	this->velocity += addedValue;
}

void GameObject::addAcceleration(glm::vec3 addedValue) {
	this->acceleration += addedValue;
}

void GameObject::updateValues() {
